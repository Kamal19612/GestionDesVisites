      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-slate-400">
              <li><a href="#" className="hover:text-vp-cyan transition-colors">Centre d'aide</a></li>
              <li><a href="#" className="hover:text-vp-cyan transition-colors">Documentation</a></li>
              <li><a href="#" className="hover:text-vp-cyan transition-colors">Contact</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-slate-500">
            © {new Date().getFullYear()} NativIA — VisitePulse. Tous droits réservés.
          </p>
